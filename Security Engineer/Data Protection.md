...
Ensuring your applications are free of flaws that cause vulnerabilities is extremly important and the use of automated security scanners can help identify weaknesses in your applications.

GCP offers the CLoud Security Scanner which probes for common vulnerabilites in Google App Engine and Compute Engine Applications.

It can automatically scan and detect four common vulnerabilities, including cross-site scripting, Flash injection, mixed content (HTTP in HTTPS) and any outdated/insecure libraries.
